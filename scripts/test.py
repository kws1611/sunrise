...
class mission:
    ...
    def process(self):
        process = {0:['Takeoff', self.wpTakeoff],
                   ...
                   5:['Land', self.ref]}.get(self.step, 'END')
